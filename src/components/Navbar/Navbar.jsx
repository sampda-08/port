...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    { id: "volunteering", label: "Extracurricular Activities" },
  ...
  return (
    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        {/* Left side with name and icons */}
        <div className="flex flex-col items-start space-y-1">
          <div className="text-lg font-semibold cursor-pointer">
            <span className="text-[#8245ec]">&lt;</span>
            <span className="text-white">Sampda</span>
            <span className="text-[#8245ec]">/</span>
            <span className="text-white">Patmase</span>
            <span className="text-[#8245ec]">&gt;</span>
          </div>
          <div className="flex space-x-3 mt-1">
            <a
              href="https://github.com/sampda-08"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/sampdapatmase/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-[#8245ec]"
            >
